...
function addCard() {
  ...
  if (card_title.length > 18) {
    return alert("title should not be greater than 18 characters");
  }
...
function addList() {
  ...
  if (card_item.length > 18) {
    return alert("list should be greater than 18 characters");
  }
